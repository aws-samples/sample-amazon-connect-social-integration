...
class FacebookMessengerConnectChatStack(Stack):
    ...
    def create_resources(self):
        ...
        self.secrets = secretsmanager.Secret(
            ...
            secret_string_value=SecretValue("FROM_MESSENGER"),
        )
    ...
    def set_up_env_vars(self):
        for l in [
            ...
            l.add_environment("CONFIG_PARAM_NAME", config.MESSENGER_CONFIG_PARAM_NAME)
        ...
        self.lambda_functions.messages_in.add_environment(
            "USERS_TABLE_NAME", self.tables.messenger_users.table_name
        )

    def create_parameters(self):
        self.config_parameters = self.create_ssm_parameter(
            config.MESSENGER_CONFIG_PARAM_NAME,
            json.dumps(config.MESSENGER_CONFIG_PARAM_CONTENT),
        )
        self.create_ssm_parameter(
            config.MESSENGER_WEBHOOK_PARAM_NAME,
    ...
    def set_up_permissions(self):
        ...
        self.tables.messenger_users.grant_read_write_data(
            self.lambda_functions.messages_in
        )
